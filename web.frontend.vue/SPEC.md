...
5. App stores are hydrated with devices, assets, organisations, groups, settings (including inherited maps/AI keys), permissions, roles, and authenticated user data.
