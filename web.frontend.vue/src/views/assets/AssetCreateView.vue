	...
	<form class="vform mt-16" autocomplete="off" @click="clearMessage">
		<div class="vform__row mt-6 " :class="{ 'vform__disabled': confirmOn }">
			...
			<div class="vform__group">
				...
				<VueSelect :isDisabled="confirmOn" class="vform__group" :style="vueSelectStyles" v-model="asset_type" :options="[
		...
		<div class="vform__row mt-6 " :class="{ 'vform__disabled': confirmOn }">
			<div class="vform__group">
				...
				<VueSelect :isDisabled="confirmOn" class="vform__group" :style="vueSelectStyles" v-model="organisation_id" :options="getOrganisations" placeholder="" />
			</div>

			<div class="vform__group">
				<label class="vform__label">Device<span class="vform__required">*</span></label>
				<VueSelect :isDisabled="confirmOn" class="vform__group" :style="vueSelectStyles" v-model="device_id" :options="getDevices" placeholder="" />
			</div>
		</div>
	</form>
</template>
